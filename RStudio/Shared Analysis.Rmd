...
In order to answer our research question we need to load the data and relevant packages that allow us to complete the previously mentioned subsetting and the statistical tests required to compare the estimated death rates between certain groups.
...
```{r}
# Finding with single digit number represents the racial/sex levle of the STUB_NAME variable 
